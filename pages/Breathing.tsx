      ...
      <main className="flex-1 flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-0">
          ...
          <div className="flex items-center gap-8 mt-8">
            <button
              className="w-12 h-12 rounded-full bg-white dark:bg-card-dark text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 shadow-sm flex items-center justify-center transition-all hover:scale-105"
