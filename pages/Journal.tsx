      ...
      <main className="flex-1 flex gap-6 p-4 h-full overflow-hidden">
        ...
        <div className="w-80 flex-shrink-0 flex flex-col gap-4 hidden lg:flex">
          <div className="flex items-center gap-2 mb-2">
            <Link
              to="/"
              className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-text-muted dark:text-gray-400"
            >
              <ArrowLeft size={20} />
            </Link>
          ...
          <div className="bg-surface-light dark:bg-card-dark rounded-2xl p-4 shadow-sm flex flex-col flex-1 overflow-hidden">
            <div className="relative mb-4">
              ...
              />
              <input
                className="w-full pl-9 pr-4 py-2.5 bg-gray-50 dark:bg-gray-800 border-none rounded-xl text-sm focus:ring-1 focus:ring-primary dark:text-white placeholder-gray-400 outline-none"
            ...
            <div className="flex justify-between items-center mb-3 px-1">
              <h3 className="text-xs font-semibold text-text-muted dark:text-gray-400 uppercase tracking-wider">
                Lịch sử ghi chép
              </h3>
            ...
            <div className="overflow-y-auto hide-scrollbar flex-1 space-y-3 pr-1">
              ...
              <div className="group bg-white dark:bg-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-100 dark:border-gray-700 p-4 rounded-xl cursor-pointer transition-all hover:shadow-md">
                ...
                <p className="text-sm text-text-muted dark:text-gray-400 line-clamp-2 mb-3">
                  Sáng nay mình dậy sớm, uống một tách trà và ngắm bình minh...
                </p>
                <div className="flex gap-2">
                  <span className="px-2 py-0.5 rounded-md bg-blue-50 dark:bg-blue-900/30 text-[10px] font-bold text-blue-500 uppercase">
                    Biết ơn
                  </span>
                  <span className="px-2 py-0.5 rounded-md bg-green-50 dark:bg-green-900/30 text-[10px] font-bold text-green-500 uppercase">
                    Yên bình
                  </span>
                </div>
              </div>
              ...
              <div className="group bg-white dark:bg-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-100 dark:border-gray-700 p-4 rounded-xl cursor-pointer transition-all hover:shadow-md">
                ...
                <p className="text-sm text-text-muted dark:text-gray-400 line-clamp-2 mb-3">
                  Có một chút mệt mỏi nhưng mọi thứ đã hoàn thành tốt đẹp...
                </p>
                <div className="flex gap-2">
                  <span className="px-2 py-0.5 rounded-md bg-orange-50 dark:bg-orange-900/30 text-[10px] font-bold text-orange-500 uppercase">
                    Công việc
                  </span>
                </div>
              </div>
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          <header className="flex justify-between items-center mb-4 px-2 py-2">
            <Link
              to="/"
              className="lg:hidden p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-text-muted dark:text-gray-400"
            >
              <ArrowLeft size={20} />
            </Link>
          ...
          <div className="flex-1 bg-surface-light dark:bg-card-dark rounded-2xl p-8 shadow-sm flex flex-col relative overflow-hidden">
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-text-muted dark:text-gray-400">
                  Hãy để cảm xúc dẫn lối cho những dòng chữ của bạn.
                </p>
              </div>
              <div className="flex gap-2">
            ...
            <div className="flex-1 flex flex-col gap-4 overflow-y-auto hide-scrollbar pb-24">
              <input
                className="text-2xl font-semibold bg-transparent border-none p-0 placeholder-gray-300 dark:placeholder-gray-600 focus:ring-0 text-text-main dark:text-white outline-none"
              ...
              <textarea
                className="w-full flex-1 resize-none bg-transparent border-none p-0 mt-4 text-lg leading-relaxed text-text-main dark:text-gray-300 placeholder-gray-200 dark:placeholder-gray-700 focus:ring-0 outline-none"
                placeholder="Bắt đầu chia sẻ câu chuyện của bạn ở đây..."
              ></textarea>
            </div>
